                ...
                <td valign="top" class="em_aside">
                  <table width="99%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td valign="middle" align="center"><img src="  {{asset ('/images/security.png')}} " alt="Login_Alert" style="display:block; font-family:Arial, sans-serif; font-size:14px; line-height:100px; color:#c27cbb;max-width:100px;" class="em_full_img" border="0" /></td>
                    </tr>
                    <tr>
                      <td height="5" class="em_height">&nbsp;</td>
                    </tr>
